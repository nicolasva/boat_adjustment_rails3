class App.Routers.AdjustmentTypes extends Backbone.Router
  ...
  initialize: ->
    ...
    @adjustment_types_searchs = new App.Collections.AdjustmentTypesSearchs()
  ...
  edit: (context_id, firstname_id) ->
    self = @ 
    @adjustment_types_searchs.context_id = context_id
    @adjustment_types_searchs.firstname_id = firstname_id
