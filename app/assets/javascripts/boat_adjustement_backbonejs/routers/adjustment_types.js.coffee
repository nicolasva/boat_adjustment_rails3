class App.Routers.AdjustmentTypes extends Backbone.Router
  ...
  index: (city_id, context_id, firstname_id) ->
  ...
  edit: (city_id, context_id, firstname_id) ->
    ...
    @contexts_searchs.city_id = city_id
      ...
      success: (collection, response) ->
        self.boat_types.fetch
          success: (collection_boat_types, boat_types_response) ->
            @viewAdjustmentTypesEdit = new App.Views.AdjustmentTypes.Edit({adjustmentType: self.adjustmentType, adjustmentTypes: collection, boat_types: collection_boat_types, boat_type: self.boat_type, context_id: context_id, city_id: city_id, firstname_id: firstname_id, contexts_searchs: self.contexts_searchs, adjustment_types_searchs: self.adjustment_types_searchs})
