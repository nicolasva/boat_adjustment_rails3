class App.Views.AdjustmentTypes.Index extends Backbone.View
  ...
  render: ->
    @ViewsCommonViewsHeadersLinkPanel = new App.Common.CommonViews.Headers.LinkPanel(context_id: @context_id, city_id: @city_id, firstname_id: @firstname_id, template: @template_link_edit_adjustmentTypes) unless _.isEqual($(".header").children().first().children().last().children().attr("href"), "/#/contexts/#{@context_id}/users/#{@firstname_id}/adjustment_types/edit") 
